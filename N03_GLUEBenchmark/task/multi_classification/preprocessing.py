...
def load_data(args: argparse.Namespace) -> tuple: # (dict, dict, dict, int)
    ...
    if name == 'mrpc':
        ...
        train_data['idx'] = train_df['idx'].tolist()
        train_data['text1'] = train_df['question1'].tolist()
        train_data['text2'] = train_df['question2'].tolist()
        train_data['label'] = train_df['label'].tolist()
        valid_data['idx'] = valid_df['idx'].tolist()
        valid_data['text1'] = valid_df['question1'].tolist()
        valid_data['text2'] = valid_df['question2'].tolist()
        valid_data['label'] = valid_df['label'].tolist()
        test_data['idx'] = test_df['idx'].tolist()
        test_data['text1'] = test_df['question1'].tolist()
        test_data['text2'] = test_df['question2'].tolist()
        test_data['label'] = test_df['label'].tolist()
    elif name == 'mnli_m':
        dataset = load_dataset('glue', 'mnli')

        train_df = pd.DataFrame(dataset['train'])
        valid_df = pd.DataFrame(dataset['validation_matched'])
        test_df = pd.DataFrame(dataset['test_matched'])
        num_classes = 3
        ...
        test_df = pd.DataFrame(dataset['test_mismatched'])
        num_classes = 3
        ...
        train_data['text2'] = train_df['sentence'].tolist()
        train_data['label'] = train_df['label'].tolist()
        valid_data['idx'] = valid_df['idx'].tolist()
        valid_data['text1'] = valid_df['question'].tolist()
        valid_data['text2'] = valid_df['sentence'].tolist()
        valid_data['label'] = valid_df['label'].tolist()
        test_data['idx'] = test_df['idx'].tolist()
        test_data['text1'] = test_df['question'].tolist()
        test_data['text2'] = test_df['sentence'].tolist()
        test_data['label'] = test_df['label'].tolist()
    elif name == 'rte':
