...
class ArgParser():
    def __init__(self):
        ...
        self.proj_name = 'Base_Translation'
        ...
        dataset_list = ['wmt16_de_en', 'wmt16_en_de',
                        'wmt16_cs_en', 'wmt16_en_cs',
                        'wmt14_fr_en', 'wmt14_en_fr',]
        ...
        self.parser.add_argument('--proj_name', type=str, default='Base_Translation',
                                 help='Name of the project.')
        model_type_list = ['lstm', 'gru', 'rnn', 'transformer', 't5']
        ...
        self.parser.add_argument('--vocab_size', type=int, default=32000,
                                 help='Vocabulary size of the model; Default is 32000')
